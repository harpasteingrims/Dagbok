class VoyagesUI():
    ...
    @classmethod
    def show_overview_voyage(cls):
        """ This prints the overview of all voyages """
        print("\n{}".format(cls.LENGTH_STAR*"*"))
        print("OVERVIEW OF VOYAGES")
        print("\nflugvel lala")

    @classmethod
    def show_voyage_menu(cls):
        """ This prints out the voyage menu """
        print(cls.LENGTH_STAR*"*")
        print("VOYAGES")
        print()
        ...
        if action_str == "1":
            cls.show_overview_voyage()
        elif action_str == "2":
            cls.show_create_voyage_menu()
        elif action_str == "3":
            cls.show_not_staffed_voyages()
        elif action_str == "B" or action_str == "b":
            from MainmenuUI import MainmenuUI
            MainmenuUI.show_main_menu()

    @classmethod
    def show_assign_staff_form(cls):
    ...
    @classmethod
    def show_create_voyage_menu(cls):
        ...
        if action_str == "1":
            ...
            cls.show_create_manually_form()
        elif action_str == "B" or action_str == "b":
            cls.show_create_voyage_menu()
    
    @classmethod
    def show_see_common(cls):
        """ This prints out all the common voyages """
        print("\n{}".format(cls.LENGTH_STAR*"*"))
        print("SEE COMMON VOYAGES")

    @classmethod
    def show_create_manually_form(cls):
    ...
    @classmethod
    def show_not_staffed_voyages(cls):
