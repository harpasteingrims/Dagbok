...
class CreateIO():
    def store_pilot(self, new_pilot):
        """this func takes pilot object and writes it in pilots.csv"""
    ...
    def store_cabincrew(self, new_cabincrew):
        """this func takes cabincrew object and writes it in CabinCrew.csv"""
    ...
    def store_destination(self, new_destination):
        """this func takes destination object and writes it in Destinations.csv"""
    ...
    def store_voyage(self, new_voyage):
        """this func takes voyage object and writes it in Flights.csv with and without crew"""
    ...
    def store_voyage_with_crew(self, new_voyage):
        """this func takes voyage object and writes it in Flights.csv with crew"""
